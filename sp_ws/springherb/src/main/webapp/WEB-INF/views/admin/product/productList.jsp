...
<form name="frmList" method="post"
	action="<c:url value='/admin/product/productList.do'/>">
	<div class="divRight">
		이벤트 상품 조회 <select name="eventName">
			<option value=""></option>
			<option value="NEW"
			...
			src="<c:url value='/resources/images/bt_search3.png'/>"
			align="absmiddle">
	</div>
	<div class="divList">
					...
					<c:forEach var="vo" items="${list }">
						<tr class="align_center">
							<td><input type="checkbox" name="pdItems[${idx }].productNo"
								value="${vo.productNo }"> <input type="hidden"
								name="pdItems[${idx}].imageURL" value="${vo.imageURL}">
							</td>
							<td><a href=""> <img
	...
	<div class="divRight">
		<input type="button" value="선택한 상품 삭제" id="btMultiDel"><br>
		<br> 선택한 상품을 <select name="eventSel">
			<option value=""></option>
			<option value="NEW">신상품으로</option>
			<option value="BEST">인기상품으로</option>
			<option value="MD">MD추천상품으로</option>
		</select> <input type="button" value="등록" id="btMultiAdd">
	</div>
</form>
