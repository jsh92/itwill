...
public class SubUseridGUI extends javax.swing.JFrame implements ActionListener{
    ...
    public SubUseridGUI(MemberFrame memberFrame, String userid){
        this();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubUseridGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SubUseridGUI().setVisible(true);
            }
        });
    }
    ...
    private void useridDup() throws SQLException {
        ...
        //2
        int result=dao.duplicateId(id);
        
        //3
        if(result==MemberDAO.USABLE){
            int opt=JOptionPane.showConfirmDialog(this, id
                + "는 사용가능한 아이디입니다. 사용하시겠습니까?",
                    "아이디 중복확인", JOptionPane.YES_NO_OPTION);
            
            if(opt==JOptionPane.YES_OPTION){
                this.dispose();
                memberFrame.tfUserid.setText(id);
